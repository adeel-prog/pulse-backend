...
DEFAULT_USER_AGENT = (
    "Mozilla/5.0 (compatible; LinkedInDataAppender/0.2.0; "
...
class ProfileFetcher:
    ...
    This client does not send cookies, session tokens, or login credentials,
    and it does not attempt to bypass authentication or anti-bot controls.
    """
